...
class BackgroundImage extends Component{
  render(){
    return(
      <Image source={require('../assets/iOS/images/congressImage.png')} style={styles.backgroundImage}>
        {this.props.children}
      </Image>
    );
  }
      ...
      <View style={styles.textcontainer}>
        <View style={styles.headerContainer} >
          <View style={styles.headerLeftContainer}>
            ...
            <Text style={styles.textHeader}>45 mins ago</Text>
          </View>
          <View style={styles.headerRightContainer}>
            <Text style={styles.textHeader}>Federal Government</Text>
          </View>
        </View>
        <View style={styles.textcontainerMain} >
          <View style={styles.DiscussionHeaderContainer}>
            <Text style={styles.DiscussionHeaderText}>CONGRESS:</Text>
          </View>
...
class CongressComponent extends Component {
  render(){
    return(
...
module.exports = CongressComponent;
